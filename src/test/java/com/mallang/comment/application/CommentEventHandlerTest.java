...
class CommentEventHandlerTest extends ServiceTest {
    ...
    class 포스트_삭제_이벤트를_받아 {
        ...
        void 해당_포스트에_달린_댓글들을_모두_제거한다() {
            ...
            Long ohterMemberId = 회원을_저장한다("ohter");
            Blog blog = 블로그_개설(memberId, "mallang-log");
            Long postId1 = 포스트를_저장한다(memberId, blog.getName(), "제목", "내용");
            Long postId2 = 포스트를_저장한다(memberId, blog.getName(), "제목2", "내용1");
            Long post1Comment1 = 댓글을_작성한다(postId1, "댓1", true, ohterMemberId);
            ...
            댓글을_작성한다(postId2, "댓1", true, ohterMemberId); // no delete
