...
class PostViewStatisticJobTest {
    ...
    void 집계되지_않은_모든_조회_이력을_가져와_포스트별로_그리고_일자별로_개수를_집계한다() {
        ...
        postViewHistoryRepository.save(new PostViewHistory(randomUUID(), 1L, 시간_2000년_10월_4일_10시_0분));
        postViewHistoryRepository.save(new PostViewHistory(randomUUID(), 1L, 시간_2000년_10월_4일_10시_59분));
        postViewHistoryRepository.save(new PostViewHistory(randomUUID(), 1L, 시간_2000년_10월_4일_11시_0분));

        postViewHistoryRepository.save(new PostViewHistory(randomUUID(), 1L, 시간_2000년_10월_5일_0시_30분));
        postViewHistoryRepository.save(new PostViewHistory(randomUUID(), 1L, 시간_2000년_10월_5일_0시_30분));
        postViewHistoryRepository.save(new PostViewHistory(randomUUID(), 1L, 시간_2000년_10월_5일_1시_22분));

        postViewHistoryRepository.save(new PostViewHistory(randomUUID(), 1L, 시간_2001년_10월_19일_20시_2분));

        postViewHistoryRepository.save(new PostViewHistory(randomUUID(), 2L, 시간_2000년_10월_4일_10시_0분));
        ...
        assertThat(포스트_1_통계_2000년_10월_4일.getPostId()).isEqualTo(1);
        ...
        assertThat(포스트_1_통계_2000년_10월_5일.getPostId()).isEqualTo(1);
        ...
        assertThat(포스트_1_통계_2001년_10월_19일.getPostId()).isEqualTo(1);
        ...
        assertThat(포스트_2_통계_2000년_10월_4일.getPostId()).isEqualTo(2);
    ...
    void 이미_존재하는_통계에_대해서는_개수가_증가한다() {
        ...
        Optional<PostViewStatistic> statistic = postViewStatisticRepository
                .findByPostIdAndStatisticDate(1L, 시간_2000년_10월_4일);
        assertThat(statistic).isPresent();
        PostViewStatistic postViewStatistic = statistic.get();
        assertThat(postViewStatistic.getPostId()).isEqualTo(1);
        ...
        statistic = postViewStatisticRepository.findByPostIdAndStatisticDate(1L, 시간_2000년_10월_4일);
        assertThat(statistic).isPresent();
