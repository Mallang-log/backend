...
public class PostAcceptanceTest extends AcceptanceTest {
    ...
    void 포스트를_업데이트한다() {
        // given
        var 말랑_세션_ID = 회원가입과_로그인_후_세션_ID_반환("말랑");
        var 생성된_포스트_ID = 포스트_생성(말랑_세션_ID, "첫 포스트", "첫 포스트이네요.", 없음(), "태그1");
        var 카테고리_ID = 카테고리_생성(말랑_세션_ID, "Spring", 없음());
    ...
    class 포스트_검색_시 extends AcceptanceTest {
        ...
        void 포스트_전체_조회() {
            ...
            // when
            var 응답 = 포스트_전체_조회_요청(없음(), 없음(), 없음(), 없음(), 없음(), 없음());
        ...
        void 특정_카테고리로_검색하면_해당_카테고리와_하위_카테고리에_해당하는_포스트가_조회된다() {
            ...
            // when
            var 응답 = 포스트_전체_조회_요청(카테고리_ID, 없음(), 없음(), 없음(), 없음(), 없음());
        ...
        void 태그로_필터링() {
            ...
            var 말랑_세션_ID = 회원가입과_로그인_후_세션_ID_반환("말랑");
            var 카테고리_ID = 카테고리_생성(말랑_세션_ID, "Spring", 없음());
            var 포스트1_ID = 포스트_생성(말랑_세션_ID, "포스트1", "이건 첫번째 포스트이네요.", 없음(), "tag1", "tag2", "tag3");
            var 포스트2_ID = 포스트_생성(말랑_세션_ID, "포스트2", "이번에는 이것 저것들에 대해 알아보아요", 카테고리_ID, "tag1", "tag2", "tag4");
            var 포스트3_ID = 포스트_생성(말랑_세션_ID, "포스트3", "잘 알아보았어요!", 카테고리_ID, "tag2", "tag3");
            var 예상_데이터 = 전체_조회_항목들(
                    예상_포스트_전체_조회_응답(포스트1_ID, "말랑", 없음(), 없음(), "포스트1", "이건 첫번째 포스트이네요.",
                            "tag1", "tag2", "tag3"),
                    예상_포스트_전체_조회_응답(포스트2_ID, "말랑", 카테고리_ID, "Spring", "포스트2", "이번에는 이것 저것들에 대해 알아보아요",
            ...
            // when
            var 응답 = 포스트_전체_조회_요청(없음(), "tag1", 없음(), 없음(), 없음(), 없음());
        ...
        void 제목으로_검색() {
            // given
            var 말랑_세션_ID = 회원가입과_로그인_후_세션_ID_반환("말랑");
            var 포스트1_ID = 포스트_생성(말랑_세션_ID, "포스트1", "포스트1입니다.", 없음());
            var 포스트2_ID = 포스트_생성(말랑_세션_ID, "포스 트2", "포스트2입니다.", 없음());
            var 예상_데이터 = 전체_조회_항목들(
                    예상_포스트_전체_조회_응답(포스트1_ID, "말랑", 없음(), 없음(), "포스트1", "포스트1입니다.")
            );

            // when
            var 응답 = 포스트_전체_조회_요청(없음(), 없음(), 없음(), "포스트", 없음(), 없음());
        ...
        void 내용으로_검색() {
            // given
            var 말랑_세션_ID = 회원가입과_로그인_후_세션_ID_반환("말랑");
            var 포스트1_ID = 포스트_생성(말랑_세션_ID, "포스트 1", "포스트 1입니다.", 없음());
            var 포스트2_ID = 포스트_생성(말랑_세션_ID, "포스트 2", "포스트 2입니다.", 없음());
            var 예상_데이터 = 전체_조회_항목들(
                    예상_포스트_전체_조회_응답(포스트2_ID, "말랑", 없음(), 없음(), "포스트 2", "포스트 2입니다.")
            );

            // when
            var 응답 = 포스트_전체_조회_요청(없음(), 없음(), 없음(), "포스트 2", 없음(), 없음());
        ...
        void 제목_내용으로_검색() {
            ...
            var 말랑_세션_ID = 회원가입과_로그인_후_세션_ID_반환("말랑");
            var 포스트1_ID = 포스트_생성(말랑_세션_ID, "포스트 1", "포스트 1입니다.", 없음());
            var 포스트2_ID = 포스트_생성(말랑_세션_ID, "2번째", "포스트 2입니다.", 없음());
            var 예상_데이터 = 전체_조회_항목들(
            ...
            // when
            var 응답 = 포스트_전체_조회_요청(없음(), 없음(), 없음(), 없음(), 없음(), "포스트");
