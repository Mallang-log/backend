...
public class PostLikeAcceptanceTest extends AcceptanceTest {
    ...
    class 좋아요_시 {
        ...
        void 포스트에_좋아요를_누른다() {
            ...
            // when
            var 응답 = 포스트_좋아요_요청(동훈_세션_ID, 포스트_ID);
        ...
        class 보호된_포스트인_경우 {
            ...
            class 블로그_주인이_아닌_경우 {
                ...
                @Test
                void 보호된_글에_접근하지_않고서는_좋아요를_누를_수_없다() {
                    // given
                    var 말랑_세션_ID = 회원가입과_로그인_후_세션_ID_반환("말랑");
                    var 블로그_ID = 블로그_개설(말랑_세션_ID, "mallang-log");
                    var 포스트_ID = 포스트_생성(말랑_세션_ID, 블로그_ID,
                ...
                @Test
                void 보호된_글에_접근한_뒤에는_좋아요를_누를_수_있다() {
                    // given
                    var 말랑_세션_ID = 회원가입과_로그인_후_세션_ID_반환("말랑");
                    var 블로그_ID = 블로그_개설(말랑_세션_ID, "mallang-log");
                    var 포스트_ID = 포스트_생성(말랑_세션_ID, 블로그_ID,
    ...
    class 좋아요_취소_시 {
        ...
        class 보호된_포스트인_경우 {
            ...
            class 블로그_주인이_아닌_경우 {
                ...
                @Test
                void 보호된_글에_접근하지_않고서는_취소할_수_없다() {
                    // given
                    var 말랑_세션_ID = 회원가입과_로그인_후_세션_ID_반환("말랑");
                    var 블로그_ID = 블로그_개설(말랑_세션_ID, "mallang-log");
                    var 포스트_ID = 포스트_생성(말랑_세션_ID, 블로그_ID,
                    ...
                    // when
                    var 응답 = 좋아요_취소_요청(동훈_세션_ID, 포스트_ID);
