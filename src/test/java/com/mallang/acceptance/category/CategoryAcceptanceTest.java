...
public class CategoryAcceptanceTest extends AcceptanceTest {
    ...
    void 카테고리를_생성한다() {
        ...
        // when
        var 응답 = 카테고리_생성_요청(말랑_세션_ID, 블로그_ID, "Spring", 없음());
    ...
    void 하위_카테고리를_생성한다() {
        ...
        var 말랑_세션_ID = 회원가입과_로그인_후_세션_ID_반환("말랑");
        Long 블로그_ID = 블로그_개설(말랑_세션_ID, "mallang-log");
        var 상위_카테고리_생성_응답 = 카테고리_생성_요청(말랑_세션_ID, 블로그_ID, "Spring", 없음());
        var 상위_카테고리_ID = ID를_추출한다(상위_카테고리_생성_응답);

        // when
        var 응답 = 카테고리_생성_요청(말랑_세션_ID, 블로그_ID, "JPA", 상위_카테고리_ID);
    ...
    void 특정_블로그의_카테고리를_조회한다() {
        ...
        Long 동훈_블로그_ID = 블로그_개설(동훈_세션_ID, "donghun-log");
        카테고리_생성(동훈_세션_ID, 동훈_블로그_ID, "Node", 없음());

        var 말랑_세션_ID = 회원가입과_로그인_후_세션_ID_반환("말랑");
        Long 말랑_블로그_ID = 블로그_개설(말랑_세션_ID, "mallang-log");
    ...
    class 카테고리_제거_시 {
        ...
        void 하위_카테고리가_있다면_제거할_수_없다() {
            ...
            Long 블로그_ID = 블로그_개설(말랑_세션_ID, "mallang-log");
            var Spring_카테고리_ID = 카테고리_생성(말랑_세션_ID, 블로그_ID, "Spring", 없음());
            카테고리_생성(말랑_세션_ID, 블로그_ID, "JPA", Spring_카테고리_ID);
