...
class CommentAcceptanceTest extends AcceptanceTest {
    ...
    class 특정_포스트의_댓글_전체_조회_시 extends AcceptanceTest {
        ...
        void 내가_쓴_댓글에_대한_다른_사람의_비밀_대댓글은_댓글_작성자가_볼_수_있다() {
            ...
            var 동훈_비공개_댓글_ID = 댓글_작성(동훈_세션_ID, 포스트_ID, "[비밀] 동훈 댓글", 비공개);

            var 헤나_비밀_댓글_ID = 댓글_작성(헤나_세션_ID, 포스트_ID, "[비밀] 헤나 댓글", 비공개, 동훈_비공개_댓글_ID);
            var 후후_비밀_댓글_ID = 댓글_작성(후후_세션_ID, 포스트_ID, "[비밀] 후후 댓글", 비공개, 동훈_비공개_댓글_ID);

            // when
            var 댓글_작성자_조회_결과 = 특정_포스팅의_댓글_전체_조회(동훈_세션_ID, 포스트_ID);
            var 대댓글_작성자_조회_결과1 = 특정_포스팅의_댓글_전체_조회(헤나_세션_ID, 포스트_ID);
            var 대댓글_작성자_조회_결과2 = 특정_포스팅의_댓글_전체_조회(후후_세션_ID, 포스트_ID);
