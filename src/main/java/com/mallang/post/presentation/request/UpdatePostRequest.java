...
public record UpdatePostRequest(String title, String content, @Nullable Long categoryId, List<String> tags) {
    public UpdatePostCommand toCommand(Long memberId, Long postId, BlogName blogName) {
